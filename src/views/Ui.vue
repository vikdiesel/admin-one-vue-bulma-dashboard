<template>
  ...
  <main-section>
    <card-component class="is-aligned-card">
      <div class="jb-card-content-center-wrap">
  ...
  <main-section>
    <div class="has-spaced-elements">
      <card-component
        title="Confirm modal"
        :header-icon="mdiClose"
        @click="modalOneActive = true"
        class="cursor-pointer is-aligned-card"
        hoverable
      >
  ...
  <titled-section custom>
    <h1 class="jb-titled-section-title">
      Notifications
    </h1>
    <div class="jb-titled-section-control">
      <check-radio-picker
        type="switch"
  ...
  <main-section>
    <div class="jb-grid is-cards-grid has-mb">
      <card-component title="With Title">
        <div class="jb-card-content-center-wrap">With title</div>
      </card-component>

      <card-component title="Title & Icons" :icon="mdiMonitorCellphone" :header-icon="mdiClose">
        <div class="jb-card-content-center-wrap">With title & icons</div>
      </card-component>
    </div>
